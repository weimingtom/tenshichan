...
{/if}
>
<script type="text/javascript" src="http://hinanawitenshi.byethost10.com/bb.js"></script>
<script type="text/javascript">
// <![CDATA[

//error handling
empty_form = "You must write something to post";
...
p: 'Attach Image: [img]http://url_imagen[/img]',
w: 'Insert URL: [url]http://url[/url] or [url=http://url]Text URL[/url]',
a: 'Close All Opened BBCodes',
s: 'Color: [color=red]text[/color]  Note: You can use color=#FF0000',
...
<div id="bbcode">
<font color="#ffffff"><b>BB Codes</b></font><br>
<input type="button" class="sub_btn" accesskey="b" name="addbbcode0" value=" B " style="font-weight:bold; width:30px" onclick="bbstyle(0)" onmouseover="helpline('b')" />
<input type="button" class="sub_btn" accesskey="i" name="addbbcode2" value=" i " style="font-style:italic; width:30px" onclick="bbstyle(2)" onmouseover="helpline('i')" />
<input type="button" class="sub_btn" accesskey="u" name="addbbcode4" value=" u " style="width:30px" onclick="bbstyle(4)" onmouseover="helpline('u')" />
<input type="button" class="sub_btn" accesskey="q" name="addbbcode6" value="Quote" style="width:50px" onclick="bbstyle(6)" onmouseover="helpline('q')" />
<input type="button" class="sub_btn" accesskey="c" name="addbbcode8" value="Strike" style="width:40px;" onclick="bbstyle(8)" onmouseover="helpline('c')" />
<input type="button" class="sub_btn" accesskey="s" name="addbbcode16" value="Link" style="width:40px;" onclick="bbstyle(16)" onmouseover="helpline('w')" />
<input type="button" class="sub_btn" name="addbbcode18" value="Spoiler" style="width:60px" onClick="bbstyle(18)" onMouseOver="helpline('spoiler')" />
<input type="button" onClick="bbc()" value="More BBCodes" class="sub_btn">
...
<script language="Javascript" src="http://www.opromo.com/servicos/usuariosonline/useronline.php?site=siteimgboardjailbaitsorg&corfont1=66FF66&texto=6&formato=normal&tipo=tahoma&tamanho=3&simbo=4" type="text/javascript"></script>
...
//<script type="text/javascript"><!--
				set_inputs("postform");
				//--></script>
//<script language="javascript" src="http://www.clayaim.com/index.php?ref=webmonitor"></script>
